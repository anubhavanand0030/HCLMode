...
public class EmployeeServiceImplServiceLocator extends org.apache.axis.client.Service implements com.hcl.service.EmployeeServiceImplService {
    ...
    private java.lang.String EmployeeServiceImpl_address = "http://localhost:8080/RestEasyJson/services/EmployeeServiceImpl";
    ...
    public com.hcl.service.EmployeeServiceImpl getEmployeeServiceImpl() throws javax.xml.rpc.ServiceException {
    ...
    public com.hcl.service.EmployeeServiceImpl getEmployeeServiceImpl(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.service.EmployeeServiceImplSoapBindingStub _stub = new com.hcl.service.EmployeeServiceImplSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.service.EmployeeServiceImpl.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.service.EmployeeServiceImplSoapBindingStub _stub = new com.hcl.service.EmployeeServiceImplSoapBindingStub(new java.net.URL(EmployeeServiceImpl_address), this);
                _stub.setPortName(getEmployeeServiceImplWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://service.hcl.com", "EmployeeServiceImplService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://service.hcl.com", "EmployeeServiceImpl"));
        }
